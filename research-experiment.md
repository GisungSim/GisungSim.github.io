...
During the process of four-wave mixing, two photons of a single pump field are converted into a _pair of photons_, which are called probe and conjugate (see Fig.3.(right)). Thus, the probe-seed field obtain additional photons (but _cross-coupled_ and _jointly amplified_ with conjugate field), which we call _four-wave mixing gain_. Ideally, the degree of squeezing increases as the gain increases. However, there is a _tradeoff_ due to additional noise (mainly probe loss because probe experiences absorption as it closes to the atomic resonance) [M. T. Turnbull _et al_. PRA 88, 033845 (2013)]. Thus, in general, the optimum gain for squeezing ranges between 9-15 and this is true to my experiment (see Fig. 3).
